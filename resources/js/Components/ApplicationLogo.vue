...
<h1 class="font-bold font-sans text-center text-base text-[#1A202C] not-italic ml-14 mr-14 mb-3">
    IntroCept Employee Portal
</h1>
</div>

<div>
    <h1 class="mt-6 mb-3 font-bold font-sans text-xl text-[#1A202C] not-italic">

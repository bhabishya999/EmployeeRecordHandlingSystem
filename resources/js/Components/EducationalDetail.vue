        ...
        <div class="p-9">
            ...
            <div class="mt-[30px] mb-5">
                <ul class="flex">
                    ...
                    <li
                        class="font-semibold leading-normal text-lg py-2.5 px-1.5 bg-indigo-700 rounded-lg font-sans text-white mr-7"
                    >
                        Educational Details
                    </li>
            ...
            >
                <div class="flex flex-col w-2/3 mr-10">
                    <FieldArray name="users" v-slot="{ fields, push, remove }">
                        ...
                        <div
                            class="border-b-2 border-slate-100 w-full my-5"
                        ></div>
                        <button
                            @click="
                                push({
...
<script>
import Detail from "@/Layouts/Details.vue";
